        ...
        >
          <Tabs.Item active title="Wishlist">
            ...
            <div className="w-full max-w-md mt-8 ml-auto">
              <a
                href="#"
                className="flex w-full bg-arfagreen items-center justify-center rounded-lg bg-primary-700 px-3 py-2.5 text-base font-medium text-white hover:bg-primary-800"
              >
                Add all to Cart
              </a>
