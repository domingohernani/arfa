    ...
    <>
      <section className="px-4 md:px-8">
        ...
        <form className="w-full max-w-md px-8 py-5 mx-auto mt-5 border">
          <div className="grid md:grid-cols-2 md:gap-6">
            <div className="relative z-0 w-full mb-5 group">
              <input
                ...
                className="block py-2.5 px-0 w-full text-base text-gray-900 bg-transparent border-0 border-b-2 border-arfablack appearance-none dark:text-white dark:border-gray-600 dark:focus:border-arfagreen focus:outline-none focus:ring-0 focus:border-arfagreen peer"
                placeholder=" "
                required
              />
              <label
                htmlFor="floating_first_name"
                className="peer-focus:font-medium focus:border-transparent peer-focus:text-arfagreen absolute text-base text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
              >
                First name
              </label>
            </div>
          ...
          <button
            type="submit"
            class="text-white bg-arfagreen font-medium rounded-md text-base w-full sm:w-auto px-5 py-2.5 text-center "
          >
            Save
          </button>
        </form>
