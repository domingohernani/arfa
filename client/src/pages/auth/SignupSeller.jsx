...
const SignupSeller = () => {
  return (
    <section className="px-5 pt-4 pb-10">
      ...
      <img src={signupImg} alt="man image" />
      ...
      <p className="my-5 text-xs ">
        <Link to={"/"} className="underline text-arfagreen">
          Already a member?
        </Link>
      </p>
      ...
      <section className="flex flex-col items-center gap-3 ">
        <div className="flex items-center justify-center w-3/4 gap-3 py-2 border rounded-md min-w-24">
        ...
        <div className="flex items-center justify-center w-3/4 gap-3 py-2 border rounded-md min-w-24">
          ...
          <span className="text-sm text-blue-600">Continue with Facebook</span>
        </div>
      </section>
    </section>
  );
