        ...
        <div className="flex items-center h-80">
          <div className="flex flex-col gap-1 pl-5 basis-3/6">
            ...
            <button
              type="button"
              onClick={handleClose}
              className="inline-flex items-center text-sm font-medium text-gray-500 bg-white focus:outline-none hover:text-gray-900 hover:underline dark:text-gray-400 dark:hover:text-white"
            >
              Cancel
            </button>
          </div>
