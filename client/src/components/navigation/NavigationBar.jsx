...
function NavigationBar() {
  return (
    <div className="grid items-center grid-cols-11 grid-rows-2 gap-2 md:grid-rows-1">
      ...
      <div className="relative col-span-11 row-start-2 text-xs md:text-base md:col-start-2 md:col-span-4 md:row-start-1">
        <input
          type="text"
          className="w-full px-4 py-2 text-base border border-gray-300 focus:outline-none focus:border-arfagreen focus:ring-0 focus:ring-arfagreen focus:bg-white "
      ...
      <div className="flex items-center justify-end col-start-11 ">
        ...
        <Link to={"/wishlist"}>
          <button className="flex items-center justify-center gap-2 px-4 bg-transparent focus:outline-none md:px-5">
            <span className="text-xs font-normal text-arfablack md:text-base">
              Wishlist
            </span>
            <img
              src={heart}
