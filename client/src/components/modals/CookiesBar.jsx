...
const CookiesBar = () => {
  ...
  useEffect(() => {
    ...
    setIsCookieAccepted(storedConsent === "accepted");
  }, []);
  ...
  return (
    !isCookieAccepted && (
      <section className="fixed z-10 max-w-2xl p-4 mx-auto bg-white border border-gray-200 shadow-sm md:gap-x-4 right-12 bottom-16 dark:bg-gray-900 md:flex md:items-center dark:border-gray-700 rounded-2xl">
        <div className="flex items-center gap-x-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            website.{" "}
            <a href="/cookies-policy" className="text-blue-500 hover:underline">
