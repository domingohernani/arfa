  ...
  return (
    <section className="h-screen">
      ...
      <section class="py-8 bg-white md:py-16 dark:bg-gray-900 antialiased">
        <div class="max-w-screen-xl px-4 pb-4 mx-auto 2xl:px-0">
            ...
            <div class="mt-6 sm:mt-8 lg:mt-0">
              ...
              <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                ...
                <a
                  href="#"
                  title=""
                  class="text-white bg-arfagreen mt-4 sm:mt-0 bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center"
                  role="button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#ffffff"
                    class="w-4 h-4 -ms-2 me-2"
                    id="Outline"
                    viewBox="0 0 24 24"
                    width="512"
                    height="512"
